...
const VndIconSvg = () => (
  <img src="https://ads-cdn.fptplay.net/static/banner/2021/07/03_60e01b9277de060001367549.png" style={{maxWidth: '100%'}}/>
)

const Dong = () => (
  <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 220 220" style={{enableBackground: "new 0 0 220 220"}} xmlSpace="preserve">
  <g>
...
export const VndIcon = props => <Icon component={VndIconSvg} {...props} />;
export const VNDongIcon = props => <Icon component={Dong} {...props} style={{width: 25}}/>;
